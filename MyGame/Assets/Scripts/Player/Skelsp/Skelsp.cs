...
public class Skelsp : Player {
  ...
  void OnCollisionStay2D(Collision2D other) {
    DebugLogger.WriteVerbose("Skelsp OnCollisionStay2D other.gameObject.tag = {0}", other.gameObject.tag);
    switch (other.gameObject.tag) {
      case GameLevel.BorderTagName: {
          StopMovingAnim();
        }
  ...
  void OnTriggerEnter2D(Collider2D other) {
    DebugLogger.WriteInfo("Skelsp.OnTriggerEnter2D other.gameObject.tag = {0}", other.gameObject.tag);
    switch (other.gameObject.tag) {
      case GameLevel.BorderTagName: {
  ...
  void OnTriggerExit2D(Collider2D other) {
    DebugLogger.WriteInfo("Skelsp.OnTriggerExit2D other.gameObject.tag = {0}", other.gameObject.tag);
